    ...
    <div class="ml-20 px-20 pb-10 flex flex-col gap-12">
        ...
        <div class="flex w-full justify-between">
            <div class="flex flex-col gap-16">
                ...
                <div id="dropZone" class="grid grid-cols-4 grid-rows-auto gap-4 border rounded-lg relative p-5 border-primary_color p-4 [border:1px_dashed_#F07405]">
                    <div class="bg-black opacity-25 flex justify-center items-center absolute w-full h-full text-white font-bold rounded-lg hidden" id="dropEffect">Drop Here</div>
            ...
            <div class="bg-white rounded-l-lg flex p-8 w-fit gap-12">
                <button class="flex gap-10 [writing-mode:vertical-rl] rotate-180 justify-center">
                ...
                <div class="flex flex-col gap-8 h-[575px]">
