    ...
    <div class="ml-20 px-20 py-10 space-y-6">
        ...
        <div class="space-y-2 w-fit">
            ...
            @if($manteniment->responsable)
                <div class="bg-white py-4 px-8 shadow-[5px_5px_15px_2px_rgba(0,0,0,0.12)] flex gap-5 rounded-lg w-full items-center">
        ...
        <div id="box-content" class="relative w-full">
            <div class="flex gap-x-5">
                <button type="button" 
                        ...
                        data-tab="seguiment"
                        data-url="{{ url('manteniment/'.$manteniment->id.'/seguiment/partial') }}">
                    Seguiment
                </button>
                <button type="button" 
                        class="tab-button px-3 py-1 text-white rounded-t-lg bg-primary_color opacity-40" 
                        data-tab="documents"
                        data-url="{{ url('manteniment/'.$manteniment->id.'/documents/partial') }}">
                    Documents
                </button>
            </div>
