<x-app-layout>
    ...
    <div class="py-12 max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white rounded-xl">
        <h1 class="text-2xl font-bold mb-4">Nou Centre</h1>
        ...
        <form action="{{ route('center.store') }}" method="POST" class="space-y-4">
            ...
            <x-text-input id="location" name="location" type="text" placeholder="Adreça" class="mt-1 block w-full" :value="old('location')" />
            ...
            <x-text-input id="phone" name="phone" type="text" placeholder="Número de teléfon" class="mt-1 block w-full" :value="old('phone')" />
