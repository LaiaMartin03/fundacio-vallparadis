            ...
            <div class="mt-4">
                ...
                @if($professional->profile_photo_path)
                    <div class="mt-2">
                        ...
                        <img src="{{ asset('storage/' . $professional->profile_photo_path) }}" 
                             alt="Foto de perfil" 
                             class="w-24 h-24 object-cover rounded-full border-2 border-gray-300">
                    </div>
                @else
                    <div class="mt-2">
                        <p class="text-sm text-gray-500 mb-1">Sense foto de perfil</p>
            ...
            <div class="mt-4">
                ...
                @if($professional->cv_file_path)
                    <p class="text-sm text-gray-500 mt-1">
                        Archivo actual: 
                        <a href="{{ route('professional.cv.download', $professional->id) }}" target="_blank" class="text-blue-600 hover:underline">
